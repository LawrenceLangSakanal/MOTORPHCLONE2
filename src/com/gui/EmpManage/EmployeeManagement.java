...
public class EmployeeManagement extends JFrame {
    ...
    private void initComponents() {
        ...
        topPanel.setLayout(new FlowLayout(FlowLayout.LEFT, 6, 6));
        topPanel.setBackground(Theme.SIDEBAR_BG);

        JLabel lblSearch = new JLabel("Enter Employee Number:");
        lblSearch.setForeground(Theme.TEXT_ON_DARK);
        lblSearch.setFont(Theme.FONT_BODY);
        ...
        // Apply button themes
        Theme.primaryButton(btnSearch);
        Theme.primaryButton(btnLoad);
        Theme.secondaryButton(btnClear);
        Theme.dangerButton(btnExit);
        Theme.secondaryButton(btnViewLogs);
        Theme.primaryButton(btnAdd);
        Theme.primaryButton(btnUpdate);
        ...
        Theme.secondaryButton(btnViewLoginCredentials);
